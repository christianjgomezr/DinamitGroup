...
public class ICargarProfesores extends javax.swing.JFrame {
    ...
    private void desplegar_msj(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_desplegar_msj
        int T =Ctrl_Reportes.getInstance().i_copiar_archivo_prof();
        if(T>0) {
            jTextField1.setText(T+" profesores cargados con exito");
        } else {
           jTextField1.setText("Archivo invalido"); 
        }    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ICargarProfesores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ICargarProfesores().setVisible(true);
            }
        });
    }
