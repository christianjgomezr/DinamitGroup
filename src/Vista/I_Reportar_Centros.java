 ...
 * @author CarlosJosé
 */
public class I_Reportar_Centros extends javax.swing.JFrame {

    /**
     * Creates new form I_Reportar_Profesores
     */
    public I_Reportar_Centros() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Profesores por Centro");
        setResizable(false);
        ...
        Ordenar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos los Centros" }));
        ...
        Resultados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Centro", "Profesor", "Total Trabajos"
            }
        ));
        jScrollPane1.setViewportView(Resultados);
        if (Resultados.getColumnModel().getColumnCount() > 0) {
            Resultados.getColumnModel().getColumn(0).setPreferredWidth(100);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(I_Reportar_Centros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new I_Reportar_Centros().setVisible(true);
            }
        });
    }
