...
public class I_Profesores_Postgrado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Resultados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Profesor", "Nivel", "Fecha"
            }
        ));
        jScrollPane1.setViewportView(Resultados);
        if (Resultados.getColumnModel().getColumnCount() > 0) {
            Resultados.getColumnModel().getColumn(0).setPreferredWidth(200);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(I_Profesores_Postgrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
